...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Bulan Mei 2019 pada 16.18
...
--
-- Struktur dari tabel `seller_produk`
--

CREATE TABLE `seller_produk` (
  `id_seller` int(5) NOT NULL,
  `id_produk` int(10) NOT NULL,
...
--
-- Indeks untuk tabel `seller_produk`
--
ALTER TABLE `seller_produk`
...
--
ALTER TABLE `detail_user`
  MODIFY `id_detailuser` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Ketidakleluasaan untuk tabel `seller_produk`
--
ALTER TABLE `seller_produk`
  ADD CONSTRAINT `seller_produk_ibfk_1` FOREIGN KEY (`id_seller`) REFERENCES `seller` (`id_seller`),
  ADD CONSTRAINT `seller_produk_ibfk_2` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_produk`);
COMMIT;
