...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
          ...
          <a class="nav-item nav-link btn btn-success text-white tombol" href="login.php">LOGIN</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
      ...
      <a href="register.php" class="btn btn-success">JOIN US</a>
    </div>
  </div>
  <!-- akhir Jumbotron -->
  ...
  <div class="container">
    ...
    <div class="row workingspace">
      ...
      <div class="col-lg-5">
        ...
        <a href="#" class="btn btn-primary tombol">HOW WE WORK</a>
      </div>
    </div>
    <!-- akhir Workingspace -->
